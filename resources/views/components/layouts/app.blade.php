...
<head>
    ...
    <title>{{ config('app.name', 'NCESVM') }} | @yield('title', 'Page')</title>
    ...
    <script>
        ...
        var pusher = new Pusher('a3ba5ca894d0d85f2654', {
            cluster: 'ap1'
        });
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; University of Eastern Pangasinan - BSIT 2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
