<div>
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">{{ __('Edit Student') }}</h1>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mt-3">
                                <img id="profile_picture_preview"
                                    src="{{ $student_picture ? $student_picture->temporaryUrl() : ($student->getFirstMediaUrl('student_pictures') ?: 'https://via.placeholder.com/150') }}"
